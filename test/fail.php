        ...
        <div class="col-md-6 col-md-offset-3" style="margin-top:2%; ">
            <div class="col-md-12 boxborder">
                ...
                <div class="col-md-12 text-left">
                    <p>Dear <?php echo $title." ".$last_name;?>,</p>
                    <p>Your payment of <?php echo $currency." ".$amount;?> for the invoice number <?php echo $invoice_number;?> has been unsuccessful.</p>
                    <p><?php echo "Transaction Error : ".$fail_reason;?></p>
                    <p>Kindly retry or contact your bank if the problem persists.</p>
                    <p>Best wishes,</p>
...
<?php
    $subject = "Payment unsuccessful (Invoice number: $invoice_number)";
    $body="
        <p>Dear $title $customer_name, </p>
        <p> Your payment of $currency $amount for the invoice number $invoice_number has been unsuccessful.</p>
        <p>Transaction Error : $fail_reason</p>
        <p>Kindly retry or contact your bank if the problem persists.</p>
        <p>Best wishes,</p>
        <p>Far Horizon Tours Pvt. Ltd.</p>
        <p>India.</p>
